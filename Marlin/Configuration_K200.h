 ...
 *
 */
#ifndef CONFIGURATION_K200_H
#define CONFIGURATION_K200_H
...
#define CUSTOM_MACHINE_NAME "HE3D K200 - 3DR"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 297.37 // get this value from auto calibrate
...
// RDC these are calculated with fake values as they are manually set 686
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 200, 90}
 ...
 *
 * Take the following step to get the bed skew in the XY plane:
 ...
 */
#if ENABLED(BLINKM) || ENABLED(RGB_LED) || ENABLED(RGBW_LED) || ENABLED(PCA9632) || ENABLED(RGBW_LED)
